...
from db_connect import lstm_yen_res, lstm_yen_remove
...
def lstm_yen(conn, df):
    ...
    df = web.DataReader('JPYKRW=X', data_source='yahoo', start='2003-01-01')
